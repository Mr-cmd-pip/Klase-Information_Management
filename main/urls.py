...
urlpatterns = [
    ...
    path('instructorProfile/<str:email>/', views.profile, name='profile_instructor'),
    path('instructor/<int:code>/', views.course_page_instructor, name='instructor'),
    ...
    path('deleteCourse/<int:code>/', views.deleteCourse, name='deleteCourse'),
    path('courses/', views.courses, name='courses'),
    path('editCourse/<int:code>/', views.edit_course, name='edit_course'),
    path('withdraw/<int:code>/', views.withdraw_course, name='withdraw_course'),
    ...
    path('changePasswordInstructor/', views.changePasswordInstructor, name='changePasswordInstructor'),
    path('changePhoto/', views.changePhoto, name='changePhoto'),
    path('changePhotoInstructor/', views.changePhotoInstructor, name='changePhotoInstructor'),
